...
$e = new \JMS\Serializer\Accessor\ExpressionAccessorStrategy($d, new \JMS\Serializer\Accessor\DefaultAccessorStrategy());

$f = new \JMS\Serializer\JsonSerializationVisitor($b, $e);
$f->setOptions(1216);

$g = new \JMS\Serializer\XmlSerializationVisitor($b, $e);
$g->setFormatOutput(true);

$h = new \JMS\Serializer\XmlDeserializationVisitor($b);
$h->setDoctypeWhitelist(array());

$i = new \JMS\Serializer\EventDispatcher\LazyEventDispatcher(new \Symfony\Component\DependencyInjection\ServiceLocator(array('jms_serializer.doctrine_proxy_subscriber' => function () {
